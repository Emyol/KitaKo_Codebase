...
/// Tapping a person navigates to their detail screen with all their photos.
/// Long-pressing shows options to label or merge persons.
///
/// This screen gracefully handles the face service being unavailable
/// by showing an informational message instead of crashing.
...
class _PeopleScreenState extends State<PeopleScreen> {
  ...
  void _openPersonDetail(Person person) {
    Navigator.of(context).push(
      ...
      // Refresh after returning (label might have changed)
      _loadPersons();
    });
  }
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(
              '${_persons.length} ${_persons.length == 1 ? 'person' : 'people'} '

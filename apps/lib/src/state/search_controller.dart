...
class SearchController extends ChangeNotifier {
  ...
  Future<void> search(String query, {int? topK}) async {
  ...
  /// Set the absolute similarity floor
  void setAbsoluteThreshold(double value) {
    _searchService.absoluteThreshold = value;
  }

  /// Set the relative cutoff (fraction of best result's score)
  void setRelativeThreshold(double value) {
    _searchService.relativeThreshold = value;
  }
